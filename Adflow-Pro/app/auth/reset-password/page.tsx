      ...
      <div className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-6xl items-center gap-8 lg:grid-cols-[0.92fr_1.08fr]">
          ...
          <CardContent className="p-8">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-600">
                Enter and confirm your new password below to update it directly.
              </p>
            </div>
        ...
        <div className="rounded-[2rem] bg-slate-950 p-8 text-white shadow-[0_40px_120px_rgba(15,23,42,0.24)]">
          ...
          <h2 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">
            Update your password directly and jump back in.
          </h2>
          <div className="mt-6 space-y-4 text-sm leading-7 text-slate-300">
            <div className="flex items-start gap-3 rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
              ...
              <p>
                Your new password and confirm password fields are available right here for quick updating.
              </p>
            </div>
            <div className="flex items-start gap-3 rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
            ...
            <p>
              Note: Supabase requires an active session to allow updating the password directly inside the app. 
            </p>
          </div>
        </div>
      </div>
